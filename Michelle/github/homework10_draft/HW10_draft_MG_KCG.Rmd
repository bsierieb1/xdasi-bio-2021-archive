...
b) If the data look highly skewed, it might be useful to normalize the data. Do this by converting the total number of cases in each group to a proportion of total cases. Then, rplot and retest for normality.
