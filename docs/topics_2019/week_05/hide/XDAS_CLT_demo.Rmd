---
title: 'The Central Limit Theorem, Sampling Error, Confidence Intervals, and t-Distribution'
...
```{r}
# mean of 10 samples of size 100 drawn from a continuous uniform distribution
# ranging from 0 to 1
...
```{r}
# find the mean of 10 draws from the population, and repeat this 10 times
...
# plot the mean of 100 sets of random samples of size 10
ud.mean.hist(n=100,size=10)
```
...
c = 100  # hod the constant variable at 100
...
<!-- The samples look relatively normally distributed.
