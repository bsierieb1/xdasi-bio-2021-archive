...
Finally, there are some low-throughput single-cell methods that do involve sequencing the entire transcripts (e.g. SMART-Seq). In suc cases, it is more appropriate to use normalization methods that take into account transcript length, e.g. **TPM**.
