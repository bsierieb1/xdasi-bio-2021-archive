...
+ What is the test statistic?
  + *The number of children with polio in the vaccinated group (n=200000)*
  
+ What is the null distribution?
  + *The binomial distribution with p=0.00057, the proportion of unvaccinated children who contracted polio.*

+ What are the $p$-values for each group given the data?
  + *Control group: $\sim 0.52$ (we expect p=0.5, but the observed value is not exact due to discretization)*
  + *Vaccine group: $\sim 10^{-19}$*
