...
Now that you've seen how to simulate a normally distributed sample and compare it to an ideal one, repeat the simulation exercise above on the height dataset.
