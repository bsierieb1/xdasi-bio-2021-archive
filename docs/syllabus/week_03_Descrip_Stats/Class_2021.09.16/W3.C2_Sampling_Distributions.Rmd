...
```{r class.source="fold-hide", fig.width=5, fig.asp=.7}
# ================================================================ #
...
```{r class.source = 'fold-hide', message=FALSE, warning=FALSE, fig.width=5, fig.asp=.7}
...
$$95\% CI \approx \bar{X} \pm 2*SE_\bar{X}$$
To be more precise, we can use a $z$-score of 1.96 instead of 2 for the limits of the range, which is a bit closer to demarcating 95% of the data.
