...
```{r}
# population data
Placebo_pop = read.csv("placebo_pop.csv", header = FALSE)
Placebo_pop = Placebo_pop[,1]  # turn the data into a simple vector
...
Draw a strip chart showing the mean, SEM, and 95%CI.
