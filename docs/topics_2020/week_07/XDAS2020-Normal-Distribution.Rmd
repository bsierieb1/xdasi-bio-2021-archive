...
+ Class notes: [**Sampling distributions of sample estimates**](https://xdas.bio.nyu.edu/topics/week_03/XDAS_CLT_2020_all.html)
...
![Normal distributions with different mean and variance](Images/Normal_Distribution_PDF.png){width=50%}
