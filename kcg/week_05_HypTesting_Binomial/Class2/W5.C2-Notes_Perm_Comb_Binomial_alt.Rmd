...
Let's go back to Mendel's peas. Crossing two true-breeding lines of round ($AA$) and wrinkled ($aa) peas would give an F1 generation with all heterozygotes ($Aa$).
