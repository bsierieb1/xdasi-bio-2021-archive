...
The samples do not look normally distributed, but a KS or Wilcoxon rank sum test give p-values > 0.05 (barely), so it seems like it will be ok to use the standards from plate 1 for quantification.
```
