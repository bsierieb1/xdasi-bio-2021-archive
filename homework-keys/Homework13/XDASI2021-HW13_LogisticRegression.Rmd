...
# radius
type = "Radius"
roc_result = roc(... ,  # predictions on test set
                 ... )  # observed diagnoses from test set
...
# predictions
cancer_pred_top.features = 

# ROC
roc_result_top.features = roc( ... )

## ROC for nonredundant predictors ========================================= ##
roc_result_nonredundant = 
...
lr.fold = glm(formula = diagnosis ~ ... ,      # fill in the formula here
