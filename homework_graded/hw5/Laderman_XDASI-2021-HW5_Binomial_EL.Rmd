...
nperm = factorial(6) / factorial(4)
ncomb = nperm / factorial(2)
ncomb

#This is the same as 2 Wnt-responsive cells because the events are mutually exclusive so if there are 4 wnt-insensitive cells there must be two wnt-responsive cells
...
plot(x=x.range , y=dbinom(x.range, 50, 0.11) , type="histogram",
     main="PDF",
     xlab="expected # of white moths", ylab="point probability")
plot(x=x.range , y=pbinom(x.range, 50, 0.11) , type="stair",
     main="CDF",
...
```{r}
#You would need a dataframe for ggplot or a simple vector for hist()
```
