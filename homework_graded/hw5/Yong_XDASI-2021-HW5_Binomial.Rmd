...
author: "Jacob Bernoulli [Luok Wen Yong]"
date: "Due: 10/8/2021"
...
#It is the same, as calculting the combibantion of Wnt-sensitive cells complementary and thus inderctly calculate the ways to get Wnt-insensitive cells. 
...
(choose(6,2)*(pI^4)*(pW^2))+(choose(6,1)*(pI^5)*(pW^1))+(choose(6,0)*(pI^6)*(pW^0))
...
# is this significant?
# The difference is significant as it is lower than the threshold of p=0.05
```
