...
# ============================================================================ ## 
# load the file
tigers.df = read.csv("/Users/wellsburrell/Desktop/R/R/Week 2/Homework2/data/Ex2.2A_tigers.csv", header = TRUE, stringsAsFactors = TRUE)
...
tiger.table
# tiger.table.df = 
tiger.table.df = data.frame(sort(tiger.table, decreasing = TRUE))
tiger.table.df
...
data.class(tiger.table.df)

# ============================================================================ #
# write the table to a file
write.table(tiger.table.df, file = "./data/tiger_attack_freq.csv", row.names = FALSE, col.names = c("Activity","Frequency"))
```
...
ggsave(filename = "my.ggplot.PNG", plot = my.ggplot)
```
...
```{r, collapse=TRUE, error=TRUE}
# load the data
salmonSizeData <- read.csv("/Users/wellsburrell/Desktop/R/R/Week 2/Homework2/data/Fig2.2-5_SalmonBodySize.csv")
...
hist(salmonSizeData$massKg, col = "firebrick", xlab = "Salmon Mass Kg", ylab = "Frequency", main = "Salmon Mass in Kg")

# ============================================================================ #
# b. Replot with bin size (interval width) = 0.1
hist(salmonSizeData$massKg, col = "firebrick", xlab = "Salmon Mass Kg", ylab = "Frequency", main = "Salmon Mass in Kg", breaks = (range(salmonSizeData$massKg)[2]- range(salmonSizeData$massKg)[1])/0.1, xlim = range(1,4), ylim = range(0,30))
...
qplot(salmonSizeData$massKg, data = salmonSizeData, 
      col=I("black"), fill=I("firebrick"))

# ============================================================================ #
# b. body mass histogram with ggplot
ggplot(data = salmonSizeData,
       mapping = aes(massKg)) +
  geom_histogram(col="black", fill="firebrick")
...
ggplot(data = salmonSizeData,
       mapping = aes(massKg)) +
  geom_histogram(col="black", fill="firebrick", binwidth = 0.1, boundary = 0, closed = "left")
...
avianMalaria = read.csv("/Users/wellsburrell/Desktop/R/R/Week 2/Homework2/data/Ex2.3A_malaria.csv", header = TRUE) 
...
plot(salmonSizeData$lengthMm, salmonSizeData$massKg, xlab = "Salmon Length mM", ylab = "Mass kg", col = "firebrick")
...
ggplot( data = salmonSizeData,
  ...
  geom_point(size = 1, col = "black", shape = 1) +
