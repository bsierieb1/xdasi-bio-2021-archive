...
write.table(tiger.table.df, "./data/tiger_attack_freq.csv", row.names = FALSE, col.names = c("Activity", "Frequency"))
...
pdf("tigers_freq_plot.pdf") #Able to write the plot as a pdf in the current directory
...
ggsave("myggplot_tigerfrequency.png", plot = my.ggplot)
...
range_diff = range(salmonSizeData$massKg)[2] - range(salmonSizeData$massKg)[1]
hist(salmonSizeData$massKg,
     col = "firebrick",
     xlab = "Body mass (kg)",
...
ggplot(data = salmonSizeData,
  ...
  geom_point(shape = 1, col = "firebrick", size = 4) +
