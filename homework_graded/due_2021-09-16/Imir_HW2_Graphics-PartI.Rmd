...
# ============================================================================ ## 
# load the file
tigers.df = read.csv("/Users/ozanimir/Documents/NYU Files/Statistics in Biology/Week 3 Directory/data/Ex2.2A_tigers.csv",
                     header = TRUE)
...
tiger.table = table(data = tigers.df$activity)
tiger.table
tiger.table_decreasing = sort(x = tiger.table,decreasing = TRUE)
tiger.table_decreasing
tiger.table.df = data.frame(tiger.table_decreasing)

# Option 2: all at once ---------------------------------------------------- #
tiger.table.df = data.frame(sort(x = table(data = tigers.df$activity),decreasing = TRUE))
tiger.table.df
...
pdf("tiger_table.pdf", width = 16)
plot(tiger.table.df$Activity, tiger.table.df$Frequency, xlab = c("Activity"), ylab = c("Frequency"))
dev.off()
...
```{r, error=TRUE}
firebrick.plot = barplot(tiger.table.df$Frequency, col = "firebrick")
...
tiger.barplot = barplot(tiger.table.df$Frequency, col = "firebrick", ylim = c(0,50))
tiger.barplot
...
my.ggplot = ggplot(data = tiger.table.df, 
                   mapping = aes(tiger.table.df,
                                 x = tiger.table.df$Activity, 
                                 y = tiger.table.df$Frequency)) +
...
ggsave(filename = "my.ggplot.png",
       plot = my.ggplot,
       path = "/Users/ozanimir/Documents/NYU Files/Statistics in Biology/Week 3 Directory")
```
...
```{r, collapse=TRUE, error=TRUE}
# load the data
salmonSizeData=read.csv("/Users/ozanimir/Documents/NYU Files/Statistics in Biology/Week 3 Directory/data/Fig2.2-5_SalmonBodySize.csv", header = TRUE)
# take a look
salmonSizeData
```
...
massKg.histogram.first=hist(x=salmonSizeData$massKg, fill = "firebrick", xlab = "Body mass(kg)")
massKg.histogram.second=hist(x=salmonSizeData$massKg, breaks = "Sturges", col = "firebrick", main = "Salmon Size Distribution", xlim = c(1,4), ylim = c(0,30), xlab = "Salmon size distribution")
graphs = par(massKg.histogram.first, massKg.histogram.second, mfrow = c(1,2))

# ============================================================================ #
# a. Draw a histogram showing frequency data for body mass (base R)
massKg.histogram = hist(x=salmonSizeData$massKg, fill = "firebrick", xlab = "Body mass(kg)")

# ============================================================================ #
# b. Replot with bin size (interval width) = 0.1
massKg.histogram = hist(x=salmonSizeData$massKg, breaks = "Sturges", col = "firebrick", xlim = c(1,4), ylim = c(0,30), xlab = "Body mass(kg)")
...
qplot(x = salmonSizeData$massKg, data = salmonSizeData, col=I("black"), fill=I("firebrick"))

# ============================================================================ #
# b. body mass histogram with ggplot
ggplot(data = salmonSizeData, aes(x = salmonSizeData$massKg)) + geom_histogram(data = salmonSizeData, aes(), fill = "firebrick", col = "black")
...
ggplot(data = salmonSizeData, aes(x = salmonSizeData$massKg)) + 
  geom_histogram(data = salmonSizeData, aes(), fill = "firebrick", col = "black", binwidth=0.1, boundary = 0, closed = "left") +
...
avianMalaria <- read.csv("/Users/ozanimir/Documents/NYU Files/Statistics in Biology/Week 3 Directory/data/Ex2.3A_malaria.csv")
avianMalaria
```
...
ggplot(data = avianMalaria, aes(x = treatment, y = response, fill = response)) + geom_bar(stat = "identity") + facet_wrap(~ response)
```
...
ggplot(data = avianMalaria, aes(x = treatment, fill = response)) +
...
```{r, error=TRUE}
mosaicplot(x = avianMalaria.table)
```
...
avianMalaria.table_transposed = t(x = avianMalaria.table)
avianMalaria.table_transposed
mosaicplot(x = avianMalaria.table_transposed)
```
...
plot(x = salmonSizeData$lengthMm, y = salmonSizeData$massKg)
...
ggplot(data = salmonSizeData, aes(x = lengthMm, y = massKg, fill = massKg)) +
  geom_point(stat = "identity", size = 1, col = 1) +
  labs(x = "Treatment", y = "Frequency") +
  theme_classic() 
