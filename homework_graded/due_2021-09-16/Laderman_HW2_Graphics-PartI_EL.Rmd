...
write.csv(tiger.table.df, file = 'data/tiger_attack_freq.csv')
...
ggsave(my.ggplot, filename = 'tiger_freq_barplot_ggplot.png')
```
...
pdf('tiger_barplot_ggplot_not_ggsave.pdf')
...
hist(x=salmonSizeData$massKg, col='firebrick', xlab = 'Body mass (kg)')


# ============================================================================ #
# b. Replot with bin size (interval width) = 0.1

hist(x=salmonSizeData$massKg, col='firebrick', xlab = 'Body mass (kg)', breaks = 30, ylim = c(0, 30), xlim = c(1, 4))
...
ggplot(data = salmonSizeData,
  ...
  geom_histogram(col=I("black"), fill=I("firebrick"))
...
ggplot(data = salmonSizeData,
       mapping = aes(x=massKg)) +
  geom_histogram(col=I("black"), fill=I("firebrick"), boundary = 0, closed = "left", binwidth = 0.1) +
...
plot(salmonSizeData$lengthMm, salmonSizeData$massKg, xlab = 'Length (mm)', ylab = 'Mass (kg)', col = 'firebrick')
